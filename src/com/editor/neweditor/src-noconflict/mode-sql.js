...
var SqlHighlightRules = function() {
    ...
    var keywords = (
        ...
        "when|else|end|type|left|right|join|on|outer|desc|asc|union|function|return"
    );
    ...
    var builtinFunctions = (
        "count|min|max|avg|sum|rank|now|coalesce|in|out"
    );
    
    var group = (
        "varchar2|number|date|long|clob|blob"
    );
